...
const ENGINE_PROFILE_COMMANDS: Record<string, ProfileCommandConfig> = {
  ...
  repository_overview: {
    ...
    aggressive: { cmd: 'node /home/stavan/SecureLensUpdated1/apps/backend/scripts/github-security-scanner.js "<TARGET>" "repository_overview" 2>/dev/null || echo "{\\"findings\\":[]}"', timeout: 60 },
  },
  code_security: {
    ...
    aggressive: { cmd: 'node /home/stavan/SecureLensUpdated1/apps/backend/scripts/github-security-scanner.js "<TARGET>" "code_security" 2>/dev/null || echo "{\\"findings\\":[]}"', timeout: 120 },
  },
  secret_detection: {
    ...
    aggressive: { cmd: 'node /home/stavan/SecureLensUpdated1/apps/backend/scripts/github-security-scanner.js "<TARGET>" "secret_detection" 2>/dev/null || echo "{\\"findings\\":[]}"', timeout: 90 },
  },
  dependency_analysis: {
    ...
    aggressive: { cmd: 'node /home/stavan/SecureLensUpdated1/apps/backend/scripts/github-security-scanner.js "<TARGET>" "dependency_analysis" 2>/dev/null || echo "{\\"findings\\":[]}"', timeout: 120 },
  },
  infrastructure_security: {
    ...
    aggressive: { cmd: 'node /home/stavan/SecureLensUpdated1/apps/backend/scripts/github-security-scanner.js "<TARGET>" "infrastructure_security" 2>/dev/null || echo "{\\"findings\\":[]}"', timeout: 120 },
  },
  cicd_security: {
    ...
    aggressive: { cmd: 'node /home/stavan/SecureLensUpdated1/apps/backend/scripts/github-security-scanner.js "<TARGET>" "cicd_security" 2>/dev/null || echo "{\\"findings\\":[]}"', timeout: 90 },
  },
  license_compliance: {
    ...
    aggressive: { cmd: 'node /home/stavan/SecureLensUpdated1/apps/backend/scripts/github-security-scanner.js "<TARGET>" "license_compliance" 2>/dev/null || echo "{\\"findings\\":[]}"', timeout: 60 },
  },
  container_security: {
    ...
    aggressive: { cmd: 'node /home/stavan/SecureLensUpdated1/apps/backend/scripts/github-security-scanner.js "<TARGET>" "container_security" 2>/dev/null || echo "{\\"findings\\":[]}"', timeout: 90 },
  },
  secret_finder: {
    fast: { cmd: 'node /home/stavan/SecureLensUpdated1/apps/backend/scripts/github-security-scanner.js "<TARGET>" "secret_detection" 2>/dev/null || echo "{\\"findings\\":[]}"', timeout: 25 },
    normal: { cmd: 'node /home/stavan/SecureLensUpdated1/apps/backend/scripts/github-security-scanner.js "<TARGET>" "secret_detection" 2>/dev/null || echo "{\\"findings\\":[]}"', timeout: 45 },
  ...
  http_security: {
    ...
    aggressive: { cmd: 'node /home/stavan/SecureLensUpdated1/apps/backend/scripts/http-security-audit.js "<TARGET>" 2>/dev/null || echo "[]"', timeout: 45 },
  },
  api_security: {
    ...
    aggressive: { cmd: 'node /home/stavan/SecureLensUpdated1/apps/backend/scripts/api-security-audit.js "<TARGET>" 2>/dev/null || echo "[]"', timeout: 45 },
  },
  waf_detection: {
    ...
    aggressive: { cmd: 'node /home/stavan/SecureLensUpdated1/apps/backend/scripts/waf-security-audit.js "<TARGET>" 2>/dev/null || echo "[]"', timeout: 30 },
  },
  email_security: {
    ...
    aggressive: { cmd: 'node /home/stavan/SecureLensUpdated1/apps/backend/scripts/email-security-audit.js "<TARGET>" 2>/dev/null || echo "[]"', timeout: 40 },
  },
  privacy_compliance: {
    ...
    aggressive: { cmd: 'node /home/stavan/SecureLensUpdated1/apps/backend/scripts/privacy-security-audit.js "<TARGET>" 2>/dev/null || echo "[]"', timeout: 40 },
  },
  security_intelligence: {
    ...
    aggressive: { cmd: 'node /home/stavan/SecureLensUpdated1/apps/backend/scripts/security-intelligence.js "<TARGET>" 2>/dev/null || echo "[]"', timeout: 30 },
  },
};
