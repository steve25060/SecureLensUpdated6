...
const SEED_FINDINGS: Finding[] = [
  // Website Findings
  { id: 'f-w01', title: 'SQL Injection in Login Endpoint', severity: 'CRITICAL', source: 'Nuclei', target: 'https://acme-enterprise.com', status: 'NEW', category: 'Injection', cwe: 'CWE-89', owasp: 'A03:2021-Injection', cvss: 9.8, description: 'The login endpoint concatenates user input directly into a dynamic SQL query without parameterization.', remediation: 'Use parameterized queries or prepared statements for all database access.', createdAt: getDynamicISODate(0), targetType: 'WEBSITE' },
